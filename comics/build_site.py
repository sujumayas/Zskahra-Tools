...
.subnav a{font-family:'Cinzel',serif;font-size:11px;letter-spacing:1px;color:var(--gold-dim);text-decoration:none;text-transform:uppercase;border:1px solid var(--border);border-radius:4px;padding:8px 16px;transition:all .15s}
.subnav a:hover{border-color:var(--gold-dim);color:var(--gold)}
...
<main>
  <div class="subnav"><a href="personajes/index.html">Ver personajes &rarr;</a></div>
